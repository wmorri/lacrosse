...
if (req.url ~ "^(/website-test/|/teams/|/)(?:(?:index|litespeed)\.php/)?") {
set req.http.X-Turpentine-Secret-Handshake = "1";
if (req.url ~ "^(/website-test/|/teams/|/)(?:(?:index|litespeed)\.php/)?admin") {
...
if (req.url ~ "^(/website-test/|/teams/|/)(?:(?:index|litespeed)\.php/)?(?:admin|api|cron\.php)" ||
