...
//        }
...

	{
	    ...
	    try {
                ...
                $this->handleProduct($parts, $add_products_array, $importData, $product, $productcounter);
...
//                $option->save();
    ...
    public function handleProduct(&$parts, &$add_products_array, $importData, &$product, $productcounter)

    {
        if (method_exists($product, 'getTypeId')) {
            ...
            if ($productstockItem->getStockItem()->getManageStock() == 1 && $stockItem->getQty() != "0.0000") {
                    ...
                    if ($stockItem->getQty() > 0 || $product->getTypeId() == "bundle") {
                		...
                		if ($part_type == "configurable") {
							...
							if($productcounter == 1) {
								...
								$product = $this->createProduct($parts[0], $importData['store_id'], "I-oe_productstandin2");
								...
								$product = $this->createProduct($parts[0], $importData['store_id'], "I-oe_productstandin3");
								...
								$product = $this->createProduct($parts[0], $importData['store_id'], "I-oe_productstandin4");
...

    {
        ...
        if (isset($parts[2]) && $parts[2] != "configurable" && $parts[2] != "bundle") {
        ...
        } else if(isset($parts[2]) && $parts[2] == "configurable") {
