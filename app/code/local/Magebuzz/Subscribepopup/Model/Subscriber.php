...
class Magebuzz_Subscribepopup_Model_Subscriber extends Mage_Newsletter_Model_Subscriber {
	const XML_PATH_SUCCESS_EMAIL_TEMPLATE       = 'newsletter/subscription/success_email_template';
	const XML_PATH_SUCCESS_EMAIL_TEMPLATE_WITH_COUPON       = 'subscribepopup/coupon_code_setting/email_template';
	...
	public function sendConfirmationSuccessEmail() {
		...
		if(Mage::helper('subscribepopup')->isEnabled() && Mage::helper('subscribepopup')->isAllowCreateCouponCode()) {
			$model = Mage::getModel('subscribepopup/subscribepopup');
