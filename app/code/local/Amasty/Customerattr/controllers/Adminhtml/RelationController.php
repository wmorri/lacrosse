...
class Amasty_Customerattr_Adminhtml_RelationController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function editAction()
    {
        ...
        if (count($attributes) == 0) {
			...
			Mage::getSingleton('adminhtml/session')->addError(Mage::helper('amcustomerattr')->__('There is no attributes to create relations. Please create attribute first below'));
