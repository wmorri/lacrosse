...
class Amasty_Customerattr_Block_Data_Form_Element_Selectimg extends Varien_Data_Form_Element_Abstract
{
    ...
    protected function _optionToHtml($option, $selected)
    {
        ...
        $html .= '<div><input type="radio" name="' . parent::getName() . '" id="' . $this->getData('html_id') . '___' . $this->_escape($option['value']) . '" rel="' . $this->getData('html_id') . '" value="' . $this->_escape($option['value']) . '"';
